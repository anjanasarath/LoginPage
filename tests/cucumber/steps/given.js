...
import fillInField from '../support/action/fillInField';
import invalidateToken from '../support/action/invalidateToken';
import isEnabled from '../support/check/isEnabled';
import isVisible from '../support/check/isVisible';
import openWebsite from '../support/action/openWebsite';
import resizeScreenSize from '../support/action/resizeScreenSize';
import loginPage from '../pages/loginPage';
import privacyRecordsPage from '../pages/privacyRecordsPage';
...
module.exports = function given() {
  ...
  this.Given(
      /^I have the role "([^"]*)?"$/,
      loginPage.assignRole
  );

  this.Given(
        /^my token is no longer valid$/,
        invalidateToken
    );

  this.Given(
        /^I am on the privacy records page$/,
        privacyRecordsPage.go
    );
