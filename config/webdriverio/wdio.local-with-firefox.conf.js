...
module.exports.config = {
  ...
  baseUrl: 'https://spronq.privacyperfect.com',
    //
  ...
  reporterOptions: {
    allure: {
      outputDir: 'reports/allure-results/webdriverio'
    }
  },
  ...
  cucumberOpts: {
    require: [
      './tests/cucumber/support/reporters/allure.js',
    ...
    strict: true, // <boolean> fail if there are any undefined or pending
                         // steps
    tags: require('../../tests/cucumber/tagProcessor')(process.argv),
